                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="fw-bold">
                                @php
                                    $user_id = $source === "wallet"? $deposit->wallet->user->id : $deposit->user_id;
                                    $username = $source === "wallet"? @$deposit->wallet->user->username : @$deposit->user->username
                                @endphp
                                <a href="{{ route('admin.users.detail', $user_id) }}">{{ $username }}</a>
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Method')
            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    @if($details != null)
                        ...
                        @endforeach
                        @if($deposit->method_code < 1000)
                            @include('admin.deposit.gateway_data',['details'=>(array) json_decode(json_decode($details))])
                        @endif
                    @endif
