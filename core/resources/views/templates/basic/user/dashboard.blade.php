                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    ...
                                    <h4 class="my-1">{{ $general->cur_sym }}{{ showAmount(@$widget['total_wallet_amount']) }}
                                    </h4>
                                    <a href="{{ route('user.wallet.fund') }}" class="mt-2 accounts-buttons__link btn btn--base btn--sm">
                                        <i class="fas fa-plus"></i> Add to wallet
                                    </a>
                                    <a class="mt-2" style="display: inline-block; font-size: 12px;" href="{{ route('user.wallet.history') }}">view wallet history</a>
                                </div>
                                <span class="widgets-icons-2">
...
@push('style')
    <style>
        ...
        .user-dashboard div[class*=col-xl-6]:nth-child(1) .custom--card-two {
            background-color: hsl(var(--info)/0.1) !important;
            border-left: 5px solid hsl(var(--info));
        }

        .user-dashboard div[class*=col-xl-6]:nth-child(1) .custom--card-two .widgets-icons-2 {
            color: hsl(var(--info));
        }

        .user-dashboard div[class*=col-xl-6]:nth-child(2) .custom--card-two {
            background-color: hsl(var(--base)/0.1) !important;
            border-left: 5px solid hsl(var(--base));
        }

        .user-dashboard div[class*=col-xl-6]:nth-child(2) .custom--card-two .widgets-icons-2 {
            color: hsl(var(--base));
        }

        .user-dashboard div[class*=col-xl-6]:nth-child(3) .custom--card-two {
            background-color: hsl(var(--purple)/0.1) !important;
            border-left: 5px solid hsl(var(--purple));
        }

        .user-dashboard div[class*=col-xl-6]:nth-child(3) .custom--card-two .widgets-icons-2 {
            color: hsl(var(--purple));
        }

        .user-dashboard div[class*=col-xl-6]:nth-child(4) .custom--card-two {
            background-color: hsl(var(--warning)/0.1) !important;
            border-left: 5px solid hsl(var(--warning));
        }

        .user-dashboard div[class*=col-xl-6]:nth-child(4) .custom--card-two .widgets-icons-2 {
